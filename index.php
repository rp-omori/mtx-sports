        ...
        <div class="message__top">
          ...
          <div class="message__wrapper">
            ...
            <p class="message__text fade-anime-text js-titleAnimationTarget">
              私がスポーツドクターを志したのは、私自身が高校時代にアメリカンフットボールの練習中、膝に大怪我を負った経験がきっかけです。<br>
              ...
              これまで整形外科医として診療をする中で、手術加療を選択せざるを得ない方や、まだ手術に至らないまでも、痛みで苦しんでいる方を多く診てきました。<br>
              日本の保険診療は全ての方々に同様の質の高い医療を安価で提供できる一方、海外では認められているような再生医療を含む先進医療を導入するのには非常に時間がかかっているのが事実です。<br><br>

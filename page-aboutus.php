      ...
      <div class="concept-lead__wrapper">
        <div class="concept-lead__left">
          ...
          <p class="concept-lead__text">
            これまでアスリートの競技人生・身体的障害のある方の人生に長年向き合い、身体的な機能改善に取り組んできた私たちMTXは、<br>
            今回、新たに医師を仲間に加え、海外では当たり前にあるような医療と運動療法を組み合わせた複合施設型のクリニックを作ります目標とする複合施設とは、ケガや転倒を予防するといった基礎的な運動機能のケアから始まり、事故で受傷した際の治療やリハビリ、その後のパフォーマンスアップまでを一貫してみられる空間です。
          </p>
        </div>
          ...
          <div class="concept-background__main-inner">
            <div class="concept-background__left">
              ...
              <p class="concept-background__main-text">
                近年動画サイトなどで、球速アップや足が速くなる方法を教える動画が増えてきました。しかし、それは視聴者が自分に合った方法を取捨選択できる保証はなく、合わない方法を試みて逆にパフォーマンスが低下したり、ケガをする人が多くなってきています。<br>
                また高齢者の方で、運動が健康に重要であることを認識しているにもかかわらず、どこに行けばどうすれば良いのかがわからず、悩んでいる方もいらっしゃいます。<br><br>
                そもそも、医療機関に来院される患者さんは、すでに中長期の治療を必要とする重い状態になっている方が多く、本来であれば、そのような状態になる前に早期発見できることが重要です。しかしながら、ほとんどの運動施設には医療者はおらず、問題の早期発見につながる「不調」や「痛み」を気軽に相談できる環境にはなっていないのが現状です。<br>
                当院では、医療機関とトレーニング施設をシームレスにつぐことで、お互いが抱える弱点の解消をできる仕組みを作り、この課題解決に挑戦します。<br>
                これまで、MTX単体では対応できなかった「ケガの治療」と「リハビリ」を医師と理学療法士が行い、医療機関単体では対応不可能だった運動機能向上のトレーニングをトレーナーがカバーしていくことで、老若男女を問わず健康で活動的な日々を送っていただけるよう、医師・理学療法士・トレーナー陣の連携で患者様の治療に携わります。<br><br>
                不可能を可能に。絶望から希望へ。<br>
                私たちは、挑戦・探求し続けます。
              </p>
            </div>
          ...
          <div class="concept-background__main-inner">
            <div class="concept-background__left">
              <div class="concept-background__title-wrapper">
                ...
                <p class="concept-background__title">“ 治る ” 関節治療とは</p>
              </div>
              <p class="concept-background__main-text">
                ケガや加齢による関節の変形は、現代の医学で元通りに戻すことは難しいとされています。そのため重度の変形、特に膝や股関節であれば変形してしまった関節の骨を切除し、人工物に取り替える人工関節置換術や、骨を切ってストレスをうまく逃す骨切り術が盛んに行われています。<br><br>
              ...
              <div class="concept-interview__comment-wrapper">
                ...
                <div class="concept-interview__comment">
                  ...
                  <div class="concept-interview__comment-inner">
                    <p class="concept-interview__comment-name">富岡</p>
                    <p class="concept-interview__comment-text">
                      結局、整形外科が９割くらいの印象です。スポーツドクターって本当は病院で手術をしたり精密検査をしたりするタイプと、スポーツの現場で選手やトレーナーと病院の橋渡しをするタイプがいるんです。けれど日本だと、後者のアプローチが難しく、どうしても病院にいて選手が怪我をしたり不調を訴えて来るのを待って、後手にまわってしまう事が多いんです。僕は自分から選手の元に行きたいんですよ。
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div class="concept-interview__comment">
                  ...
                  <div class="concept-interview__comment-inner">
                    ...
                    <p class="concept-interview__comment-text">
                      ...
                      また、アカデミーに来る方たちの中には、ケガの結果で自分に絶望を感じてくる方も結構いらっしゃいます。昨日の試合でケガをしたため、もしかしたら明日からボールを一生投げられないかもしれないといった不安を抱えている人が少なくないです。彼ら彼女らに対して、ここできちんと休む、この日はこういうトレーニングを行う、投げ方のフォームをこう修正する。<br>
                      そうすればまたボールが投げられる、と具体的にトレーニングのやり方と、その先の展望を語り続けたいです。そうすると、“明日から俺、頑張ります”って明るく変わっていくんですよ。<br>

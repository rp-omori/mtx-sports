          ...
          <div class="concept-background__main-inner">
            <div class="concept-background__left">
              ...
              <p class="concept-background__main-text">
                ...
                そこで、長年スポーツ指導活動を行ってきた我々は、新たに医師を仲間に加えることで、海外では当たり前にあるような複合施設を作ることを目標としました。目標とする複合施設とは、ケガけがや転倒を予防するといった基礎的な運動機能のケアから始まり、事故で受傷した際の治療やリハビリ、その後のパフォーマンスアップまでを一貫してみられる空間です。<br><br>
                そもそも、医療機関に来院される患者さんはすでに中長期の治療を必要とする重い状態になっていることが多いです。本来であれば、このような状態になる前に早期発見できれば良いのですが、ほとんどの運動施設には医療者がおらず、問題の早期発見につながる不調や痛みを気軽に相談できる環境にはなっておりません。この大きな矛盾を含む課題を解決すべく、当施設では、医療機関とトレーニング施設をシームレスにつなげることで、お互いが抱える欠点の解消を行います。これまでＭＴＸでは対応できなかったケガの治療とリハビリは医師と理学療法士が行い、医療機関では手が出せなかった運動機能の向上は、トレーナーがカバーしていくことで、老若男女を問わず健康で活動的な日々を送っていただけることを目標とします。
              </p>
            </div>

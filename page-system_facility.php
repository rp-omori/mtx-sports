    ...
    <div id="system" class="facility-systemArea">
      <div class="facility-systemArea__inner">
        ...
        <div class="facility-systemArea__inner_txt">
          <p>
            一人の患者さんに対し、医師・トレーナー・理学療法士がチームを組んで治療していきます。<br>
            ケガをした人や、パフォーマンスを発揮できないと悩んでいるアスリート。<br>
            また、日常生活でちょっと関節に違和感のある高齢者の方や、成長痛が強いお子様のお悩みに関するご相談など、<br>
            広く対応が可能な治療体制を持っています。<br><br>
            痛みやしびれの根本的な原因を、診察と動きの評価に基いて、医師が治療プログラムの計画をおこないます。<br>

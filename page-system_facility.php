    ...
    <div id="system" class="facility-systemArea">
      <div class="facility-systemArea__inner">
        ...
        <div class="facility-systemArea__inner_txt">
          <p>
          一人の患者さんに対し、医師・トレーナー・理学療法士がチームを組んで治療していきます。ケガをした人や、<br class="pc">パフォーマンスを発揮できないと悩んでいるアスリート。また、日常生活でちょっと関節に違和感のある高齢者の方や、<br class="pc">成長痛が強いお子様のお悩みに関するご相談など、広く対応が可能な治療体制を持っています。<br>
          <br>
          “再生医療”と“運動療法（リハビリ）”<br>
          <br>
          痛みやしびれの根本的な原因を、医師が診察と動きの評価に基づき、治療プログラムの計画をおこないます。<br class="pc">医師のつくった治療プログラムに基づき、医師・理学療法士・トレーナーが連携し、<br class="pc">根本的な痛みや悩みの改善に取り組める治療を提供いていきます。
          </p>
        </div>
        ...
        <div class="facility-collaboratingArea__inner_contents">
          ...
          <div class="facility-collaboratingArea__inner_contents_box reverse">
            ...
            <div class="facility-collaboratingArea__inner_contents_box_right">
              ...
              <div class="facility-collaboratingArea__inner_contents_box_right_txt">
                <p>
                  スイスで開発されたDDシステム、イタリアで開発されたD-WALLの二つを揃えている四ツ谷にオープンした日本で唯一のトレーニング施設です。ＤＤで下半身の測定とトレーニングを行い、D-WALLで上半身とバランストレーニングを行うことができます。<br>
        ...
        <div class="facility-collaboratingArea__inner_contents">
          ...
          <div class="facility-collaboratingArea__inner_contents_box reverse">
            ...
            <div class="facility-collaboratingArea__inner_contents_box_right">
              ...
              <div class="facility-collaboratingArea__inner_contents_box_right_txt">
                <p>
                  スイスで開発されたDDシステムは、ヨーロッパを中心に、イタリアセリエＡのサッカーチームや、レッドブルのパフォーマンスアップセンターに導入されていますが、日本にはまだ6台しか導入されていない貴重なマシンです。<br>
